(() => {
    ...
    var e = {
        ...
        d: (i, t) => {
            for (var r in t) e.o(t, r) && !e.o(i, r) && Object.defineProperty(i, r, {
                enumerable: !0,
                get: t[r]
            })
        },
    ...
    class h {
        ...
        checkOptions() {
            ...
            if ("text" !== this.$originEle.attr("type") && this.$originEle.attr("type")) throw `url模式下，元素的类型只能为 text,不能为 ${this.$originEle.attr("type")}`
        }
        initEle() {
            if (this.$originEle.css("display", "none"), this.$selectCard = t()('<div class="jquery-uploader-select-card">\n                <div class="jquery-uploader-select">\n                    <div class="upload-button">\n                        <i class="fa fa-plus"></i><br/>\n                        <a>Upload</a>\n                    </div>\n                </div>\n            </div>'), this.$uploaderContainer = t()('<div class="jquery-uploader-preview-container"></div>'), this.$uploader = t()('<div class="jquery-uploader"></div>').append(this.$uploaderContainer), this.options.parent ? this.options.parent.append(this.$uploader) : this.$originEle.parent().append(this.$uploader), this.options.mode === h.mode.url) {
        ...
        refreshPreviewFileList() {
            this.$uploaderContainer.empty(), this.files.forEach((e => {
                this.$uploaderContainer.append(e.$ele), e.$ele.find(".jquery-uploader-preview-action .file-delete").on("click", this.handleFileDelete.bind(this))
        ...
        createDefaultFiles(e) {
            let i = [];
            this.options.defaultValue ? i = this.options.defaultValue : e && (this.options.multiple ? e.split(",") : [e]).forEach(((e, t) => {
                let r = p(e);
                i.push({
                    name: "default" + t,
                    type: r,
            ...
            })), this.refreshPreviewFileList(), this.refreshValue()
        }
        ...
        onFileUploadSuccess(e, i) {
            ...
            e.url && e.url.startsWith("blob") && d.revokeBlobUrl(e.url), e.name = t.name || e.name, e.url = t.url, e.status = h.fileStatus.uploaded, e.$ele.find(".jquery-uploader-preview-main > img").attr("src", e.url), this.refreshPreviewFileList(), this.refreshValue()
        }
        ...
        handleFileSelect() {
            t()(`<input type="file" ${this.options.multiple?"multiple":""} accept="image/png, image/jpg, image/jpeg"/>`).on("change", (e => {
        ...
        handleFileUpload() {
            ...
            })), this.$originEle.trigger("before-upload", e), e.forEach((e => {
                this.$originEle.trigger("uploading", e);
                try {
                    this.fileCardDefault(e.$ele), e.$ele.find(s).show(), this.options.ajaxConfig.ajaxRequester(this.options.ajaxConfig, e, (i => {
